...
def denormalise_stl(args):
    ...
    for line in lines:
        if line.startswith('#') or len(line) < 2:
            ...
            delaym = delayk - delayk % args.decval
...
def run_mr(args):
    args.uuts = [ acq400_hapi.Acq2106(u) for u in args.uut ]
    master = args.uuts[0]
    ...
    for u in args.uuts:
        ...
        u.s0.gpg_clk = '1,1,1'
        u.s0.GPG_ENABLE = '0'
        u.load_gpg(lit_stl, args.verbose > 0)
...
def run_main():
    ...
    parser.add_argument('--decval', default=8, type=int, help="decimation value")
