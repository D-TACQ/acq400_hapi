...
def run_main():
    ...
    parser.add_argument('--create_data', default="0", type=str, help="Whether to create fake data and upload it to tree.")
    ...
    parser.add_argument('--oneshot', default=1, type=int, help='Whether to upload a single file, regardless of file size.')
