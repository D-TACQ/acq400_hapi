...
def run_main():
    ...
    parser.add_argument('--overlay', default=0, type=int,
                        help="Whether to overlay the channel data or to give each channel its own plot.")
    ...
    parser.add_argument('--rate', default=1000000, type=int,
                        help="Whether the data from in the tree is segmented or not.")
