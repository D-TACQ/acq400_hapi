...
#loads alternating waveforms into awg and checks correct waveform was run. loops forever


#Usage:
#./awg_interweave_loop.sh ao_uut acq_uut 
#./awg_interweave_loop.sh ao_uut acq_uut turbo
#./awg_interweave_loop.sh ao_uut acq_uut normal /some/path/acq400_hapi
...
mode=${3:-'normal'} #normal or turbo enable turbo mode on uut first #> bb load --mode 1 --port 52233
